...
<body>
    <header class="showcase">
        ...
        <div class="showcase-content">
            ...
            <input type="email" name="email" id="mail" placeholder="Email address" autocomplete="off">
    ...
    <section class="lastsec">
        <div class="faq">
            ...
            <div class="input">
                <a href="#" class="btn-rounded btn-lg"><button>Developed By: Mukesh Kumar</button></a>
            </div>
        </div>
    </section>
